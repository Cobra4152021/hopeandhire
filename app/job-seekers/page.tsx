        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg mb-12 text-gray-600 max-w-3xl mx-auto">
              We&apos;re dedicated to helping you navigate your path to
              meaningful employment with resources, support, and opportunities
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <Link href="/job-seekers/job-postings">
                      <Button className="w-full mt-4 bg-teal text-white hover:bg-teal-dark">
                        View Job Postings
                      </Button>
                    </Link>
                  </CardContent>
            ...
            <TabsContent value="skills">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <Card>
                  ...
                  <CardContent>
                    <p className="mb-4">
                      Our skills assessment tool helps you identify your current
                      skills and areas where you can develop to become more
                    ...
                    <div className="bg-light-bg p-4 rounded-lg mb-4">
                      ...
                      <ul className="space-y-2 text-sm">
                        <li className="flex items-start">
                          <CheckCircle className="h-4 w-4 text-teal mr-2 mt-0.5 shrink-0" />
                          <span>
                            Your transferable skills from previous experiences
                          </span>
                        </li>
                        <li className="flex items-start">
                          <CheckCircle className="h-4 w-4 text-teal mr-2 mt-0.5 shrink-0" />
                    ...
                    <div className="space-y-4">
                      <div className="border-b pb-4">
                        ...
                        <p className="text-sm text-gray-600 mb-2">
                          Learn essential computer skills for the modern
                          workplace.
                        </p>
                      ...
                      <div className="border-b pb-4">
                        ...
                        <p className="text-sm text-gray-600 mb-2">
                          Develop skills for customer-facing roles across
                          industries.
                        </p>
                        <div className="flex items-center text-xs text-gray-500">
                          <Calendar className="h-3 w-3 mr-1" />
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mb-2">
                          Hands-on training in construction, electrical, and
                          more.
                        </p>
                        <div className="flex items-center text-xs text-gray-500">
                          <Calendar className="h-3 w-3 mr-1" />
              ...
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600">
                    Read about individuals who have successfully navigated their
                    ...
                    <CardContent className="p-6">
                      <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div className="md:w-2/3">
                          ...
                          <p className="mb-4">
                            &quot;After my release, I struggled to find
                            employment that would accept my background. Hope and
                            Hire connected me with a tech training program that
                            saw my potential beyond my past. Today, I work as an
                            IT support specialist for a company that values my
                          ...
                          <div className="bg-light-bg p-3 rounded-lg">
                            ...
                            <ul className="text-sm space-y-1">
                              <li className="flex items-center">
                                ...
                                <span>
                                  Completed digital skills certificate
                                </span>
                              </li>
                              <li className="flex items-center">
                                <CheckCircle className="h-3 w-3 text-teal mr-2 shrink-0" />
                                <span>
                                  Received resume and interview coaching
                                </span>
                              </li>
                              <li className="flex items-center">
                                <CheckCircle className="h-3 w-3 text-teal mr-2 shrink-0" />
                    ...
                    <CardContent className="p-6">
                      <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div className="md:w-2/3">
                          ...
                          <p className="mb-4">
                            &quot;I was determined to build a better life, but
                            didn&apos;t know where to start. The mentors at Hope
                            and Hire helped me identify my strengths and guided
                            me through training for a healthcare administration
                            role. Now I have stability, growth potential, and
                          ...
                          <div className="bg-light-bg p-3 rounded-lg">
                            ...
                            <ul className="text-sm space-y-1">
                              ...
                              <li className="flex items-center">
                                <CheckCircle className="h-3 w-3 text-teal mr-2 shrink-0" />
                                <span>
                                  Completed healthcare admin certification
                                </span>
                              </li>
                              <li className="flex items-center">
                                <CheckCircle className="h-3 w-3 text-teal mr-2 shrink-0" />
                                <span>
                                  Matched with employer through job fair
                                </span>
                              </li>
                            </ul>
                          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                ...
                advice, encouragement, and insights.
              </p>
            </div>
              ...
              <CardContent className="p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <p className="mb-4">
                      Join discussions on topics ranging from job search
                      strategies to workplace success stories.
                    </p>
                    <ul className="space-y-2 mb-6">
                      <li className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-teal mr-2 mt-0.5 shrink-0" />
                        <span>
                          Get advice from peers who&apos;ve been in your shoes
                        </span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-teal mr-2 mt-0.5 shrink-0" />
                  ...
                  <div>
                    ...
                    <p className="mb-4">
                      Connect one-on-one with a mentor who can provide
                      personalized guidance on your career journey.
                    </p>
                    <ul className="space-y-2 mb-6">
                      <li className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-teal mr-2 mt-0.5 shrink-0" />
                        <span>
                          Matched based on your career goals and industry
                        </span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-teal mr-2 mt-0.5 shrink-0" />
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Create your profile today to access all our resources and connect
            with opportunities.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/register">
