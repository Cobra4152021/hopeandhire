    ...
    <div className="flex flex-col min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg mb-8">
                Share your professional expertise to help job seekers build skills, confidence, and
                connections.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-t-4 border-teal">
              <CardContent className="pt-8">
                ...
                <p className="text-gray-600 mb-4">
                  Help job seekers create professional resumes that highlight their skills and
                  experience.
                </p>
            ...
            <Card className="border-t-4 border-teal">
              <CardContent className="pt-8">
                ...
                <p className="text-gray-600 mb-4">
                  Provide guidance on career paths, job search strategies, and professional
                  development.
                </p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start">
      ...
      <section className="py-16 bg-light-bg">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto">
            Volunteering with Hope and Hire offers meaningful benefits for both you and our job
            seekers.
          </p>
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Enhance your mentoring, leadership, and communication skills
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Connect with other professionals across various industries
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Make a tangible difference in people&apos;s lives and communities
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Access to resources and guidance to help you be effective
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Choose when and how often you volunteer to fit your lifestyle
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
