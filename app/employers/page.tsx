          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg mb-8 text-gray-600">
                Connect with pre-screened candidates who are ready to contribute to your
            ...
            <Card className="border-t-4 border-yellow">
              <CardContent className="pt-8">
                ...
                <p className="text-gray-600 mb-4">
                  Access a pool of qualified candidates who have been vetted and prepared for
                  success.
                </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Submit your job openings with detailed requirements and qualifications.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Interview, hire, and receive ongoing support for successful outcomes.
              </p>
            </div>
          </div>
        </div>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <blockquote className="border-l-4 border-teal pl-4 italic text-gray-600 mb-4">
                  &quot;Working with Hope and Hire has transformed our hiring process. The
                  candidates we&apos;ve hired are not only skilled but also incredibly motivated.
                  The ongoing support has ensured smooth transitions for everyone involved.&quot;
                </blockquote>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <blockquote className="border-l-4 border-yellow pl-4 italic text-gray-600 mb-4">
                  &quot;We&apos;ve hired five employees through Hope and Hire, and each one has
                  exceeded our expectations. The pre-screening process saved us valuable time, and
                  the quality of candidates has been consistently high.&quot;
                </blockquote>
      ...
      <section className="py-16 bg-yellow-light/20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Join our network of employers committed to creating opportunities and building stronger
            communities.
          </p>
