        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600">
              Find answers to common questions about Hope and Hire's services and how we support job seekers,
              volunteers, employers, and partner organizations.
            </p>
          </div>
        </div>
      </section>
              ...
              <div key={index} className="mb-10">
                ...
                <Accordion type="single" collapsible className="space-y-4">
                  {category.questions.map((faq, faqIndex) => (
                    <AccordionItem key={faqIndex} value={`${index}-${faqIndex}`} className="border rounded-lg p-2">
      ...
      <section className="py-12 bg-light-bg">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            We're here to help. Contact our team for more information about our services and how we can support you.
          </p>
