...
const sampleJobs = [
  ...
  },
  {
    ...
    posted: '1 week ago',
    description:
      'Join our marketing team to develop and implement marketing strategies for our clients.',
    requirements: [
  ...
  },
  {
    ...
    posted: '3 days ago',
    description:
      'Provide excellent customer service via phone and email to resolve customer inquiries and issues.',
    requirements: [
  ...
  },
  {
    ...
    posted: '5 days ago',
    description:
      'Responsible for receiving, storing, and shipping products in our warehouse facility.',
    requirements: [
