    ...
    <div className="flex flex-col min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mb-6 text-dark-text">
                Find Qualified, Motivated Talent
              </h1>
              <p className="text-lg mb-8 text-gray-600">
                Connect with pre-screened candidates who are ready to contribute
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link href="/login">
                  <Button
                    variant="outline"
                    className="border-yellow text-yellow hover:bg-yellow hover:text-dark-text"
                  >
                    Employer Login
                  </Button>
                </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-t-4 border-yellow">
              <CardContent className="pt-8">
                ...
                <p className="text-gray-600 mb-4">
                  Access a pool of qualified candidates who have been vetted and
                ...
                <ul className="space-y-2 mb-6">
                  ...
                  <li className="flex items-start">
                    <CheckCircle className="text-yellow h-5 w-5 mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">
                      Interview-ready with professional resumes
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="text-yellow h-5 w-5 mr-2 mt-0.5 flex-shrink-0" />
            ...
            <Card className="border-t-4 border-teal">
              <CardContent className="pt-8">
                ...
                <p className="text-gray-600 mb-4">
                  We provide continued assistance to ensure successful
                  employment outcomes.
                </p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-600">
                      Post-hire check-ins and support
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="text-teal h-5 w-5 mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">
                      Resources for workplace integration
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="text-teal h-5 w-5 mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">
                      Dedicated employer relationship manager
                    </span>
                  </li>
                </ul>
              </CardContent>
            ...
            <Card className="border-t-4 border-yellow">
              <CardContent className="pt-8">
                ...
                <p className="text-gray-600 mb-4">
                  Demonstrate your commitment to community development and
                  second chances.
                </p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start">
      ...
      <section className="py-16 bg-light-bg">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto">
            Our streamlined process makes it easy to find and hire qualified
            candidates.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Create an employer account and complete your company profile.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Submit your job openings with detailed requirements and
                qualifications.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Browse pre-screened candidates matched to your job requirements.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Interview, hire, and receive ongoing support for successful
                outcomes.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto">
            Hear from employers who have found valuable team members through
            Hope and Hire.
          </p>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <blockquote className="border-l-4 border-teal pl-4 italic text-gray-600 mb-4">
                  &quot;Working with Hope and Hire has transformed our hiring
                  process. The candidates we&apos;ve hired are not only skilled
                  but also incredibly motivated. The ongoing support has ensured
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <blockquote className="border-l-4 border-yellow pl-4 italic text-gray-600 mb-4">
                  &quot;We&apos;ve hired five employees through Hope and Hire,
                  and each one has exceeded our expectations. The pre-screening
                  process saved us valuable time, and the quality of candidates
      ...
      <section className="py-16 bg-yellow-light/20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Join our network of employers committed to creating opportunities
