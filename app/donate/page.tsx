...
import { CheckCircle, Heart, Users, Briefcase, Calendar } from "lucide-react"
      ...
      <section className="bg-yellow-light/30 py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-dark-text">Support Our Mission</h1>
            <p className="text-lg mb-8 text-gray-600">
              Your donation helps us create pathways to employment for individuals seeking second chances. Together, we
              can build stronger communities through meaningful work.
            </p>
                ...
                <Card>
                  <CardContent className="pt-6">
                    <div className="text-center p-6">
                      ...
                      <h2 className="text-2xl font-bold mb-4 text-dark-text">Thank You for Your Donation!</h2>
                      <p className="text-gray-600 mb-6">
                        Your generous contribution will help us continue our mission of connecting individuals with
                        meaningful employment opportunities.
                      </p>
                      <p className="text-gray-600 mb-6">
                        A receipt has been sent to your email address. Thank you for your support!
                      </p>
                      <Button onClick={() => setIsSubmitted(false)} className="bg-teal text-white hover:bg-teal-dark">
