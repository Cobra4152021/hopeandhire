          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center text-center mb-12">
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-6 text-gray-900">
                ...
                <span className="text-yellow-500">Hire</span>
              </h1>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-teal-500">
                ...
                <div className="space-y-6">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="bg-teal-50 text-teal-600 px-3 py-1 rounded-full text-sm">42 resumes</span>
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="bg-teal-50 text-teal-600 px-3 py-1 rounded-full text-sm">37 resumes</span>
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="bg-teal-50 text-teal-600 px-3 py-1 rounded-full text-sm">29 resumes</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-yellow-500">
                ...
                <div className="space-y-6">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="bg-yellow-50 text-yellow-600 px-3 py-1 rounded-full text-sm">312 resumes</span>
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="bg-yellow-50 text-yellow-600 px-3 py-1 rounded-full text-sm">287 resumes</span>
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="bg-yellow-50 text-yellow-600 px-3 py-1 rounded-full text-sm">253 resumes</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 bg-teal-600 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
                href="/volunteers"
                className="bg-white text-teal-700 hover:bg-gray-100 px-6 py-3 rounded-md font-medium transition-colors"
              >
                Become a Volunteer
              </Link>
              <Link
                href="/employers"
                className="bg-yellow-500 text-white hover:bg-yellow-600 px-6 py-3 rounded-md font-medium transition-colors"
              >
                Hire Candidates
              </Link>
              <Link
