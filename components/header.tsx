...
const callsToAction = [
  { name: "Watch Demo", href: "#", className: "text-base font-medium text-indigo-600 hover:text-indigo-500" },
  { name: "Contact Sales", href: "#", className: "text-base font-medium text-indigo-600 hover:text-indigo-500" },
]
