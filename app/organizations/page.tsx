          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg mb-8 text-gray-600">
                Connect your clients with our network of volunteers and employers to enhance their
            ...
            <Card className="border-t-4 border-teal">
              <CardContent className="pt-8">
                ...
                <p className="text-gray-600 mb-4">
                  Expand your service offerings with specialized employment support for your
                  clients.
                </p>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <blockquote className="border-l-4 border-teal pl-4 italic text-gray-600 mb-4">
                  &quot;Our partnership with Hope and Hire has significantly enhanced our ability to
                  support clients in their employment journey. The specialized resources and
                  employer connections have been invaluable to our program participants.&quot;
                </blockquote>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <blockquote className="border-l-4 border-yellow pl-4 italic text-gray-600 mb-4">
                  &quot;The collaborative approach of Hope and Hire has allowed us to offer
                  comprehensive employment services to our clients. Their volunteer network provides
                  expertise that complements our existing programs perfectly.&quot;
                </blockquote>
      ...
      <section className="py-16 bg-teal-light/20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Join our network of organizations committed to creating pathways to employment for
