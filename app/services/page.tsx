        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg mb-8 text-gray-600">
              Hope and Hire offers a range of services to help job seekers prepare for, find, and succeed in meaningful
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-gray-600 mb-4">
                At Hope and Hire, we understand that finding meaningful employment can be challenging, especially for
                individuals facing barriers such as justice involvement, gaps in employment history, or other obstacles.
              </p>
              <p className="text-gray-600 mb-4">
                Our services are designed to address these challenges by providing personalized support, professional
                guidance, and connections to employers who are committed to providing second chances.
              </p>
              <p className="text-gray-600 mb-4">
                We work with each individual to identify their strengths, address areas for growth, and develop a
                personalized plan for achieving their employment goals.
              </p>
              <p className="text-gray-600">
                Through our network of volunteer professionals and employer partners, we provide the resources, support,
                and opportunities needed to build a sustainable career.
              </p>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto">
            Our services are available to individuals who face barriers to employment and are committed to building a
            stable career.
          </p>
          <div className="max-w-3xl mx-auto">
            <Card>
              <CardContent className="p-6">
                <p className="text-gray-600 mb-4">Hope and Hire primarily serves individuals who:</p>
                ...
                <p className="text-gray-600 mt-4">
                  ...
                  to discuss your situation. We're committed to helping as many individuals as possible find pathways to
