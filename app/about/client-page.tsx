        ...
        <div className="container mx-auto px-4 py-16 max-w-4xl">
          <div className="mb-8 text-center">
            <Image
              ...
              priority
            />
            <h1 className="text-4xl font-bold mb-4 text-gray-800">About Hope&Hire</h1>
          </div>
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4 text-gray-800">
              Our Partnership with SFDSA and Protecting San Francisco
            </h2>
            <p>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4 text-gray-800">Why It Matters</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4 text-gray-800">Get Involved</h2>
            <p>
            ...
            <div className="flex flex-wrap gap-4 mt-8">
              <Button asChild size="lg" className="bg-[#26a69a] hover:bg-[#1e8e82] text-white">
