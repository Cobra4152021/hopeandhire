        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg mb-8 text-gray-600">
              Hope and Hire is dedicated to empowering individuals with second
              chances through workforce readiness and meaningful employment
              opportunities. We believe that everyone deserves the opportunity
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Hope and Hire was founded in March of 2025 by a group of
                professionals who recognized the significant barriers to
                employment faced by individuals with justice involvement, gaps
                in employment history, and other challenges.
              </p>
              <p className="text-gray-600 mb-4">
                What began as a small volunteer initiative has grown into a
                comprehensive program that connects job seekers with volunteer
                professionals, supportive employers, and community resources.
              </p>
              <p className="text-gray-600">
                Today, Hope and Hire serves hundreds of job seekers annually,
                providing resume assistance, interview coaching, career
                counseling, and job matching services to help individuals build
                sustainable careers.
              </p>
              <p className="text-gray-600 mt-4">
                The Hope and Hire rehabilitation program was created by the
                ...
                , an organization formed by deputy sheriffs and community
                members dedicated to giving back to San Francisco and enhancing
                public safety. Our mission with Hope and Hire is to assist
                incarcerated and formerly incarcerated individuals in
                successfully re-entering society by providing pathways to
                employment. By supporting job readiness and placement, we help
                participants reintegrate productively and lawfully, reducing
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-t-4 border-teal">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600">
                  We believe in treating every individual with dignity and
                  respect, recognizing their inherent worth and potential
                  regardless of their past experiences or current circumstances.
                </p>
              </CardContent>
            </Card>
            <Card className="border-t-4 border-yellow">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600">
                  We are committed to creating opportunities for growth and
                  development, empowering individuals to build skills,
                  confidence, and connections that lead to sustainable
                  employment.
                </p>
              </CardContent>
            </Card>
            <Card className="border-t-4 border-teal">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600">
                  ...
                  working together with volunteers, employers, organizations,
                  and job seekers to create pathways to meaningful employment.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 bg-light-bg">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-12 max-w-3xl mx-auto">
            Since our founding, Hope and Hire has made a significant impact in
            the lives of job seekers and the broader community.
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Whether you're a job seeker, volunteer, employer, or organization,
            there are many ways to get involved with Hope and Hire.
          </p>
