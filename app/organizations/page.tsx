    ...
    <div className="flex flex-col min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg mb-8 text-gray-600">
                Connect your clients with our network of volunteers and
                employers to enhance their employment opportunities.
              </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto">
            Discover how a partnership with Hope and Hire can benefit your
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-t-4 border-teal">
              <CardContent className="pt-8">
                ...
                <p className="text-gray-600 mb-4">
                  Expand your service offerings with specialized employment
            ...
            <Card className="border-t-4 border-yellow">
              <CardContent className="pt-8">
                ...
                <p className="text-gray-600 mb-4">
                  Access our extensive network of volunteers, employers, and
                  support resources.
                </p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-600">
                      Skilled volunteer professionals
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="text-yellow h-5 w-5 mr-2 mt-0.5 flex-shrink-0" />
            ...
            <Card className="border-t-4 border-teal">
              <CardContent className="pt-8">
                ...
                <p className="text-gray-600 mb-4">
                  Join a community dedicated to creating meaningful employment
                  opportunities.
                </p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start">
      ...
      <section className="py-16 bg-light-bg">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto">
            Our partnership process is designed to be straightforward and
            impactful.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Complete our partnership application and meet with our team.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Connect your clients to our employment readiness services.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Collaborate with our team to provide comprehensive support.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Celebrate client successes and strengthen our partnership.
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="flex items-start mb-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-dark-text">
                      Community Reentry Alliance
                    </h3>
                    <p className="text-gray-500">
                      Reentry Support Organization
                    </p>
                  </div>
                </div>
                <blockquote className="border-l-4 border-teal pl-4 italic text-gray-600 mb-4">
                  &quot;Our partnership with Hope and Hire has significantly
                  enhanced our ability to support clients in their employment
                  journey. The specialized resources and employer connections
                  have been invaluable to our program participants.&quot;
                </blockquote>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <blockquote className="border-l-4 border-yellow pl-4 italic text-gray-600 mb-4">
                  &quot;The collaborative approach of Hope and Hire has allowed
                  us to offer comprehensive employment services to our clients.
                  Their volunteer network provides expertise that complements
                  our existing programs perfectly.&quot;
                </blockquote>
                <p className="font-medium">
      ...
      <section className="py-16 bg-teal-light/20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Join our network of organizations committed to creating pathways to
            employment for individuals seeking second chances.
          </p>
