    ...
    <div className="flex flex-col min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg mb-8">
                Share your professional expertise to help job seekers build
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link href="/login">
                  <Button className="bg-teal-dark text-white hover:bg-teal-dark/90">
                    Volunteer Login
                  </Button>
                </Link>
              </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto">
            Choose how you&apos;d like to contribute based on your skills and
            availability.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-t-4 border-teal">
              <CardContent className="pt-8">
                ...
                <p className="text-gray-600 mb-4">
                  Help job seekers create professional resumes that highlight
                ...
                <ul className="space-y-2 mb-6">
                  ...
                  <li className="flex items-start">
                    <CheckCircle className="text-teal h-5 w-5 mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">
                      HR or recruiting experience helpful
                    </span>
                  </li>
                </ul>
              </CardContent>
              ...
              <CardContent className="pt-8">
                ...
                <ul className="space-y-2 mb-6">
                  ...
                  <li className="flex items-start">
                    <CheckCircle className="text-yellow h-5 w-5 mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">
                      Hiring or management experience preferred
                    </span>
                  </li>
                </ul>
              </CardContent>
            ...
            <Card className="border-t-4 border-teal">
              <CardContent className="pt-8">
                ...
                <p className="text-gray-600 mb-4">
                  Provide guidance on career paths, job search strategies, and
                ...
                <ul className="space-y-2 mb-6">
                  ...
                  <li className="flex items-start">
                    <CheckCircle className="text-teal h-5 w-5 mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">
                      Ongoing mentorship opportunity
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="text-teal h-5 w-5 mr-2 mt-0.5 flex-shrink-0" />
      ...
      <section className="py-16 bg-light-bg">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto">
            Volunteering with Hope and Hire offers meaningful benefits for both
            you and our job seekers.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Enhance your mentoring, leadership, and communication
                        skills
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Connect with other professionals across various
                        industries
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Make a tangible difference in people&apos;s lives and
                        communities
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Receive acknowledgment for your contributions and impact
                      </p>
                    </div>
                  </li>
                </ul>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  How we help you succeed as a volunteer
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Access to resources and guidance to help you be
                        effective
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Choose when and how often you volunteer to fit your
                        lifestyle
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        A staff member to support your volunteer experience
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Connect with other volunteers through events and forums
                      </p>
                    </div>
                  </li>
                </ul>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Join our community of volunteers and help create pathways to
