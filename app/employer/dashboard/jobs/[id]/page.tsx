  ...
  const handleStatusChange = async (newStatus) => {
    try {
      ...
      toast({
        ...
        description: error.message || "There was a problem updating the job posting.",
        variant: "destructive",
      })
    }
  }
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button variant="outline" asChild>
            <a href={`/employer/dashboard/jobs/${job.id}/edit`}>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <p>{formatJobType(job.job_type)}</p>
              </div>
              <div>
                <h3 className="text-sm font-medium text-muted-foreground">Location</h3>
                <p>
                  {job.location}
                  {job.is_remote && " (Remote option available)"}
                </p>
              </div>
              <div>
                <h3 className="text-sm font-medium text-muted-foreground">Salary Range</h3>
                <p>
                  ${job.salary_min?.toLocaleString() || 0} - ${job.salary_max?.toLocaleString() || 0} per year
                </p>
              </div>
              <div>
