...
import { Briefcase, GraduationCap, MapPin, Filter, Search, ArrowUpDown, Plus } from "lucide-react"
  ...
  const filteredCandidates = candidates
    ...
    .sort((a, b) => {
      ...
      if (sortBy === "match") {
        ...
        return Number.parseInt(b.experience.split(" ")[0]) - Number.parseInt(a.experience.split(" ")[0])
      }
      return 0
    })
            ...
            <Select value={filterStatus} onValueChange={setFilterStatus}>
              <SelectTrigger>
                <div className="flex items-center">
                  ...
                  <span>{filterStatus === "all" ? "All Statuses" : `${filterStatus} Candidates`}</span>
                </div>
              </SelectTrigger>
              <SelectContent>
            ...
            <Select value={sortBy} onValueChange={setSortBy}>
              <SelectTrigger>
                <div className="flex items-center">
                  ...
                  <span>Sort by: {sortBy === "match" ? "Match Score" : sortBy === "name" ? "Name" : "Experience"}</span>
                </div>
              </SelectTrigger>
              <SelectContent>
            ...
            >
              <CardContent className="p-0">
                <div className="p-6">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        <div className="flex items-center">
                          ...
                          {candidate.featured && <Badge className="ml-2 bg-yellow text-dark-text">Featured</Badge>}
                          <Badge
                            className={`ml-2 ${
                  ...
                  <div className="mt-4 text-sm text-gray-500">Last active: {candidate.lastActive}</div>
                </div>
              </CardContent>
            </Card>
          ))
