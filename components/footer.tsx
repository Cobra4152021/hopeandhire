    ...
    <footer className="bg-gray-800 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <Link href="/" className="flex items-center">
              <Image src="/logo.png" alt="Hope and Hire Logo" width={120} height={80} className="h-auto" />
            </Link>
            ...
            <div className="flex space-x-4">
              <a
                href="https://facebook.com/hopeandhire"
                target="_blank"
              ...
              <a
                href="https://twitter.com/hopeandhire"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-white transition-colors"
                aria-label="Twitter"
              ...
              <a
                href="https://linkedin.com/company/hopeandhire"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-white transition-colors"
                aria-label="LinkedIn"
              ...
              <a
                href="https://instagram.com/hopeandhire"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-white transition-colors"
          ...
          <div>
            ...
            <address className="not-italic text-gray-300 space-y-2">
              ...
              <p>
                <a href="mailto:info@hopeandhire.org" className="hover:text-white transition-colors">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Hope and Hire. All rights reserved.</p>
